#!/usr/bin/env python3
"""
Market Bias Bounce Strategy Runner
...
from strategy import MarketBiasBounce
...
STRATEGY_NAME = "Market Bias Bounce"
...
def run_single(instrument: str, timeframe: str, cash: float = 1_000_000,
    ...
    bt = Backtester(MarketBiasBounce, df, cash=cash, commission=commission,
