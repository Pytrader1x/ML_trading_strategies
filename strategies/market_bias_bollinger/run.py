#!/usr/bin/env python3
"""
Market Bias Bollinger Strategy Runner
...
from strategy import MarketBiasBollinger
...
STRATEGY_NAME = "Market Bias Bollinger"
...
def run_single(instrument: str, timeframe: str, cash: float = 1_000_000,
    ...
    bt = Backtester(MarketBiasBollinger, df, cash=cash, commission=commission,
