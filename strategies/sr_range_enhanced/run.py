#!/usr/bin/env python3
"""
SR Range Enhanced Strategy Runner
...
from strategy import SRRangeEnhanced
...
STRATEGY_NAME = "SR Range Enhanced"
...
def run_single(instrument: str, timeframe: str, cash: float = 1_000_000,
    ...
    bt = Backtester(SRRangeEnhanced, df, cash=cash, commission=commission,
