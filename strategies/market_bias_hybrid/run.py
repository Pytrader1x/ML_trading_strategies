#!/usr/bin/env python3
"""
Market Bias Hybrid Strategy Runner
...
from strategy import MarketBiasHybrid
...
STRATEGY_NAME = "Market Bias Hybrid"
...
def run_single(instrument: str, timeframe: str, cash: float = 1_000_000,
    ...
    bt = Backtester(MarketBiasHybrid, df, cash=cash, commission=commission,
