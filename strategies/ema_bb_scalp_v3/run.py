#!/usr/bin/env python3
"""
EMA BB Scalp V3 Strategy Runner (Stat + ML Hybrid)
...
from strategy import EMABBScalpV3Strategy
...
def run_single(instrument: str, timeframe: str, cash: float = 1_000_000,
    ...
    bt = Backtester(EMABBScalpV3Strategy, df, cash=cash, commission=commission,
