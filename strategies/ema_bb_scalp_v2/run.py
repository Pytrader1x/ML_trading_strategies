#!/usr/bin/env python3
"""
EMA BB Scalp V2 Strategy Runner (ML Enhanced)
...
from strategy import EMABBScalpV2Strategy
...
def run_single(instrument: str, timeframe: str, cash: float = 1_000_000,
    ...
    bt = Backtester(EMABBScalpV2Strategy, df, cash=cash, commission=commission,
