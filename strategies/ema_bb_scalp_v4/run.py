#!/usr/bin/env python3
"""
EMA BB Scalp V4 Strategy Runner (LSTM + XGBoost Ensemble)
...
from strategy import EMABBScalpV4Strategy
...
def run_single(instrument: str, timeframe: str, cash: float = 1_000_000,
    ...
    bt = Backtester(EMABBScalpV4Strategy, df, cash=cash, commission=commission,
                    spread=spread, params=params)
...
def main():
    ...
    params = {'use_ml': not args.no_ml}
    kwargs = {'cash': args.cash, 'commission': args.commission, 'spread': args.spread,
              'n_sims': args.sims, 'start_date': args.start, 'params': params}
