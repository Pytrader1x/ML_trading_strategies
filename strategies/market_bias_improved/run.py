#!/usr/bin/env python3
"""
Market Bias Improved Exits Strategy Runner
...
from strategy import MarketBiasImproved
...
STRATEGY_NAME = "Market Bias Improved"
...
def run_single(instrument: str, timeframe: str, cash: float = 1_000_000,
    ...
    bt = Backtester(MarketBiasImproved, df, cash=cash, commission=commission,
