#!/usr/bin/env python3
"""
Market Bias Recovery Strategy Runner
...
from strategy import MarketBiasRecovery
...
STRATEGY_NAME = "Market Bias Recovery"
...
def run_single(instrument: str, timeframe: str, cash: float = 1_000_000,
    ...
    bt = Backtester(MarketBiasRecovery, df, cash=cash, commission=commission,
