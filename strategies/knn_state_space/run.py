#!/usr/bin/env python3
"""
KNN State-Space Strategy Runner

Usage:
    python run.py -i AUDUSD -t 1H
    python run.py -i AUDUSD --all
    python run.py -i AUDUSD -t 4H --sims 1000
"""
...
def run_single(instrument: str, timeframe: str, cash: float = 1_000_000,
    ...
    bt = Backtester(KNNStateSpace, df, cash=cash, commission=commission,
                    spread=spread, params=params or {})
    # Workaround: backtest engine doesn't pass params to strategy
    bt.strategy.params = params or {}
...
def main():
    ...
    parser.add_argument('-i', '--instrument', default='EURUSD', help='Currency pair')
